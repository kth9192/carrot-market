...
function Layout({ title, hasTabBar, canGoBack, children }: LayoutProps) {
  ...
  return (
    <div>
      ...
      >
        {canGoBack && <button onClick={handleGoBack}>&larr;</button>}
        {title && <span>{title}</span>}
      </div>
      <div className={cls(`pt-10`, hasTabBar ? 'pb-24' : '')}>{children}</div>
